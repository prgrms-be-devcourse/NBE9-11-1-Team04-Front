...
async function getMenuItems(): Promise<CartItem[]> {
  return [
    { id: 101, name: '카페라떼', description: 'Menu description.', iconType: 'star', initialQuantity: 1 },
    { id: 102, name: '얼그레이', description: 'Menu description.', iconType: 'star', initialQuantity: 3 },
    { id: 103, name: '치즈케이크', description: 'Menu description.', iconType: 'star', initialQuantity: 0 },
    { id: 104, name: '녹차', description: 'Menu description.', iconType: 'star', initialQuantity: 0 },
    { id: 105, name: '초코쿠키', description: 'Menu description.', iconType: 'star', initialQuantity: 0 },
  ];
}
